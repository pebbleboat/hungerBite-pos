...
export type MenuFormSelectOption = { readonly label: string; readonly value: string };

type MenuItemFormLayoutProps = {
  formik: FormikProps<MenuItemFormValues>;
  categoryOptions: readonly MenuFormSelectOption[];
  dietaryOptions: readonly MenuFormSelectOption[];
  actions: ReactNode;
};

export default function MenuItemFormLayout({
  formik,
  categoryOptions,
  dietaryOptions,
  actions,
}: MenuItemFormLayoutProps) {
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1.5">
              <BtnGroup
                ...
                wrapperClass="w-full"
                className={clsx("w-full!", dietaryError && "border-red-300!")}
